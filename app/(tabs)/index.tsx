      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {dailyVerse ? (
          <TouchableOpacity activeOpacity={0.7} onPress={() => setShowVerseDetails(!showVerseDetails)}>
            ...
            <Text style={styles.verseSource}>— {dailyVerse.book_name} {dailyVerse.chapter}:{dailyVerse.verse}</Text>
...
const styles = StyleSheet.create({
  ...
  goalCard: {
    flex: 1, backgroundColor: colors.surface, borderRadius: spacing.cardRadius,
  ...
  completionChip: {
    ...
    backgroundColor: colors.accentLight, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8,
  },
